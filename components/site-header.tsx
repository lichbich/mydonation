        ...
        <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60">
            <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-8">
                    ...
                    <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
                        <Link
                            ...
                            className={cn(
                                ...
                                pathname === "/youtube" ? "text-primary" : "text-muted-foreground"
                            )}
                        >
                ...
                <div className="flex items-center gap-3">
                    <Button asChild className="hidden sm:inline-flex shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all bg-gradient-to-r from-primary to-pink-600 border-0">
                        <Link href="/">
                            Ủng Hộ
                        </Link>
                    </Button>
                    <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
                        ...
                        <SheetContent side="left" className="w-[300px] sm:w-[400px] pr-0">
                            ...
                            <nav className="flex flex-col gap-2 mt-8 px-2">
                                ...
                                <div className="px-4">
                                    <Button asChild className="w-full justify-center shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all bg-gradient-to-r from-primary to-pink-600 border-0">
